...
const data = await getStudentById(BigInt(id));
...
return {
  title: `${data.name} - Detail Anggota`,
};
      ...
      <GlassCard>
        ...
        <CardContent>
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Terdaftar: {new Date(student.createdAt).toLocaleString()}
          </p>
        </CardContent>
      </GlassCard>
        ...
        <CardContent>
          ...
          <div className="mt-4 flex gap-2">
            ...
            <DeleteAnggotaDialog
              id={student.id.toString()}
              name={student.name}
              trigger={<button className="btn">Hapus</button>}
            />
          </div>
        </CardContent>
      </GlassCard>
